...
import { useSoftDeleteStore } from '@/hooks/useStores';
import { Store } from '@/generated/prisma';

export const StoreActionComponent = ({
  item,
  setItemSelected,
  setSheetOpen,
}: {
  ...
  const softDeleteMutation = useSoftDeleteStore();
  ...
  const handleSoftDelete = async () => {
    try {
      if (!user) {
        toast.error('Ha ocurrido un error eliminando la tienda');
        return;
      }
