...
const CustomersList = () => {
  ...
  const [itemSelected, setItemSelected] = useState<CustomerWithIncludes | null>(null);
  ...
  const { data: customersResponse, isLoading } = useAllCustomers(apiFilters);
